...
👉 **[View Full SQL Queries Here]([https://github.com/yourusername/mocha-mirage-data-cleaning/blob/main/mocha_mirage_data_cleaning.sql](https://github.com/Tadichi/Mocha-Mirage-SQL-Data-Cleaning-Project/blob/main/Cafe_sales_query.sql))**
...
👉 **[Download Cleaned Data (CSV)]([https://github.com/yourusername/mocha-mirage-data-cleaning/blob/main/data_before_after.csv](https://github.com/Tadichi/Mocha-Mirage-SQL-Data-Cleaning-Project/blob/main/Cleaned%20Data.csv))**
...
## 📂 **Files Included**
📌 **[mocha_mirage_data_cleaning.sql]([https://github.com/yourusername/mocha-mirage-data-cleaning/blob/main/mocha_mirage_data_cleaning.sql](https://github.com/Tadichi/Mocha-Mirage-SQL-Data-Cleaning-Project/blob/main/Cafe_sales_query.sql))** – Full SQL script for data cleaning steps.  
📌 **[data_before_after.csv]([https://github.com/yourusername/mocha-mirage-data-cleaning/blob/main/data_before_after.csv](https://github.com/Tadichi/Mocha-Mirage-SQL-Data-Cleaning-Project/blob/main/dirty_cafe_sales.csv))** – Sample dataset before & after cleaning.  
